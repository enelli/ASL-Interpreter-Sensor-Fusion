...
from Visual.cnn_tf import cnn_model_fn
import os
...
model = load_model('Visual/cnn_model_keras2.h5')

def get_hand_hist():
    with open("Visual/hist", "rb") as f:
        hist = pickle.load(f)
    return hist
...
def get_pred_text_from_db(pred_class):
    conn = sqlite3.connect("Visual/gesture_db.db")
